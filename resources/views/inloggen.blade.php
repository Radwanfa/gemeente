<x-page-base>
    ...
    <main class="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <form class="space-y-5" novalidate method="POST" action="/inloggen" onsubmit="log_in(event)">
            @csrf
            <div>
                <label for="username" class="block text-sm font-medium text-gray-700">E-mailadres</label>
            ...
            <button type="submit"
                class="w-full flex items-center justify-center gap-2 rounded-lg bg-brand-600 px-4 py-2 text-black font-semibold shadow hover:bg-brand-700 focus:outline-none focus:ring-2 focus:ring-brand-300">
